        ...
        <section <?php post_class(); //投稿の種類に応じたクラスを付加 ?>>
          ...
          <div class="blog-wrap">
            <div class="blog-header">
              <div class="date"><?php the_time('Y.m.d');//投稿日時を表示 パラメータで書式を指定 ?></div>
              <div class="category">カテゴリー：<?php the_category(','); //投稿の属するカテゴリー名をすべて表示 パラメータで区切り文字を指定 ?></div>
            </div>
            <div class="blog-body">
              <!-- ここから追加したコード -->
              <?php if ( in_category('news')) : ?>
                <h2>Academy Corporationからの新着情報</h2>
              <?php endif; ?>
              <!-- 追加コード ここまで -->
